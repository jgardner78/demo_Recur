...
function w(len,t,lev){
	{if(lev==0){let x=t.xpos();let y=t.ypos();
	let a=t.dir();chaos(t,10);t.set1(x,y,a);}
	
	else{t.rt(30);t.fd(len*2);v(2*len/3,t,lev-1);t.bk(len*2);
	t.lt(30);t.fd(len*2);v(2*len/3,t,lev-1);t.bk(len*2);t.rt(30);
	t.lt(60);t.fd(len*2);v(2*len/3,t,lev-1);t.bk(len*2);t.rt(30);
}}}
